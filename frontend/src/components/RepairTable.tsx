        ...
        <div className="card">
            ...
            <div className="table-responsive">
                <table className="table table-selectable card-table table-vcenter text-nowrap datatable">
                    ...
                    <tbody>
                        <tr>
                            <td><span className="text-secondary">1</span></td>
                            <td>15 Dec 2022</td>
                            <td>Naprawa klimatyzacji</td>
                            <td>101</td>
                            <td>Jan Kowalski</td>
                            <td>Robert Nowak</td>
                            <td><span className="badge bg-warning me-1"></span> W trakcie</td>
                        ...
                        <tr>
                            <td><span className="text-secondary">2</span></td>
                            <td>10 Dec 2022</td>
                            <td>Awarie światła w łazience</td>
                            <td>102</td>
                            <td>Anna Nowak</td>
                            <td>Piotr Zieliński</td>
                            <td><span className="badge bg-success me-1"></span> Ukończono</td>
                        ...
                        <tr>
                            <td><span className="text-secondary">3</span></td>
                            <td>20 Dec 2022</td>
                            <td>Uszkodzona klimatyzacja</td>
                            <td>203</td>
                            <td>Piotr Wójcik</td>
                            <td>Andrzej Wiśniewski</td>
                            <td><span className="badge bg-danger me-1"></span> Zakończone</td>
                        ...
                        <tr>
                            <td><span className="text-secondary">4</span></td>
                            <td>22 Dec 2022</td>
                        ...
                        <tr>
                            <td><span className="text-secondary">5</span></td>
                            <td>25 Dec 2022</td>
                            <td>Uszkodzony telewizor</td>
                            <td>203</td>
                            <td>Adam Wiśniewski</td>
                            <td>Piotr Nowak</td>
                            <td><span className="badge bg-secondary me-1"></span> Do wykonania</td>
            ...
            <div className="card-footer d-flex align-items-center">
                <p className="m-0 text-secondary">Wyświetlono <span>1</span> do <span>8</span> z <span>16</span> wyników</p>

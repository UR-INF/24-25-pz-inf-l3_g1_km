...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  post: (endpoint, data, config) => ipcRenderer.invoke('api:post', endpoint, data, config),

  // Wysyła zapytanie PUT przez IPC do głównego procesu
  put: (endpoint, data, config) => ipcRenderer.invoke('api:put', endpoint, data, config),

  // Wysyła zapytanie DELETE przez IPC do głównego procesu
  delete: (endpoint, config) => ipcRenderer.invoke('api:delete', endpoint, config),
